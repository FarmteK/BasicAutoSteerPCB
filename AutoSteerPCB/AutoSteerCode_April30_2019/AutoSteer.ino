...
//##########################################################################################################
  ...
  //Change depending on what happens and if it needs correcting then set to 1

                                            //Steering to the right should be positive
  #define SteeringRightIsNotPositive 0      // Set to 0 if its the right way    
  ...
  #define UseMMA_Y_Axis 0               // Set to 0 to use X axis of MMA
                                        ...
                                        // When tractor rolls to the right, it should show positive value
  #define IsRollToRightNotPositive 0    // Set to 0 if is correct
